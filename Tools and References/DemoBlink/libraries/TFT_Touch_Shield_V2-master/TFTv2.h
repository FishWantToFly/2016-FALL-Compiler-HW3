...
#define TFT_DC_LOW      digitalWrite(TFT_DC_PIN, LOW)
#define TFT_DC_HIGH     digitalWrite(TFT_DC_PIN, HIGH)
#define TFT_CS_LOW      digitalWrite(TFT_CS_PIN, LOW)
#define TFT_CS_HIGH     digitalWrite(TFT_CS_PIN, HIGH)
#define TFT_BL_OFF      digitalWrite(TFT_BL_PIN, LOW)
#define TFT_BL_ON       digitalWrite(TFT_BL_PIN, HIGH)
